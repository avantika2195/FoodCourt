...
const Delivery = () => {
  return (
    <div className='w-full bg-white py-16 px-4 '>
        <h3 className='text-orange-500 font-bold text-center'>Delivery At Your Doorsteps</h3>
...
'></img>
            <div className='flex flex-col justify-center'>
              ...
              <h1 className='md:text-4xl sm:text-3xl text-2xl font-bold py-2'>On-Demand Convinience</h1>
              <p>
            ...
            eveniet ex deserunt fuga?
              ...
              <button className='bg-black text-[#00df9a] w-[200px] rounded-md font-bold my-6 mx-auto md:mx-0 py-3'>Usher In</button>'
            </div>
        </div>
