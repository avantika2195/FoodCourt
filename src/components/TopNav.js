...
const TopNav = () => {
  ...
  return (
    < div className='max-w-[1520] mx-auto flex justify-between items-center p-4'>
        ...
        <button className='bg-orange-700 text-white hodden md:flex itemscenter py-2 rounded-full'>
        ...
        >
          ...
          />
          <h2 className='text-2xl p-4'>Food <span className='text-orange-700 font-bold'>Court</span></h2>
              <nav>
